...
/** Pipe-delimited endorsement data, schema version 2. */
...
export function serializeEndorsementData(data: EndorsementDataV2): string {
    return data.join("|");
}
...
export function makeEndorsementData(params: MakeEndorsementDataParams): string {
    ...
    const endorsementData: EndorsementDataV2 = [
        "2",
        retailTrader ?? "",
